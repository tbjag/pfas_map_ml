...
# train_loader, test_loader = dt.get_dataloaders('/media/data/iter3/train/avg_temp', '/media/data/iter3/img_target', 8, 1)
...
#     # Get metrics from new regression model
#     best_val_loss = trainer.logged_metrics["best_model_val_loss"]
#     best_val_mse = trainer.logged_metrics["best_model_val_mse"]
#     best_val_mae = trainer.logged_metrics["best_model_val_mae"]
    
#     print(stats_path)
#     with open(stats_path, "w") as f:
#         f.write(f"Best Model Validation Loss (MSE): {best_val_loss}\n")
#         f.write(f"Best Model Validation MSE: {best_val_mse}\n")
#         f.write(f"Best Model Validation MAE: {best_val_mae}\n")
