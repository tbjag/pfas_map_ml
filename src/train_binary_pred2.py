...
from models.CNNs.cnn2_binary import Model
...
def train_one_epoch(model, loader, criterion, optimizer, device):
    ...
    for inputs, target in tqdm(loader, desc="Training"):
        ...
        loss = criterion(outputs, target)  # Binary Cross Entropy Loss
...
for epoch in range(num_epochs):
    ...
    if test_loss < min_test_loss:
        ...
        min_epoch = epoch
        torch.save(model.state_dict(), "trained_models/binary_cnn2.pth")
